...
````
{
  "username": "Iron Man",
  "password": "TonyStark",
  "userTypeId": "Write te discount type here (Find it from DiscountCollection)",
...
````
{
  ...
  "customerId": "Write te customerIde here (Find it from CustomerCollection)",
  "allowanceAmount": 0,
  ...
  "invoiceLine": [
    {
      "productId": "Write te ProductId here (Find it from ProductCollection)",
      "quantity": 0
    }
  ]
}
